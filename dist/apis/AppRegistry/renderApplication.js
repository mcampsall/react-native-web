...
var renderStyleSheetToString = function renderStyleSheetToString() {
  return '<style id="' + _StyleSheet2.default.elementId + '">' + _StyleSheet2.default._renderToString() + '</style>';
};
...
function renderApplication(RootComponent, initialProps, rootTag) {
  ...
  if (!styleElement) {
    rootTag.insertAdjacentHTML('beforebegin', renderStyleSheetToString());
  }
