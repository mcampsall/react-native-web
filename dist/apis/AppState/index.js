...
var AppState = (_temp = _class = function () {
  function AppState() {
  ...
  _createClass(AppState, null, [{
    ...
    value: function removeEventListener(type, handler) {
      if (AppState.isSupported) {
        ...
        var listenerIndex = (0, _findIndex2.default)(listeners, function (pair) {
  ...
  return AppState;
}(), _class.isSupported = _ExecutionEnvironment2.default.canUseDOM && document.visibilityState, _temp);
